...
Main.render = function(framebuffer) {
	...
	Main.poly.begin(true);
	Main.poly.drawImageTriangle(10,10,300,10,50,400,0,0,1,0,0,1,kha_Assets.images.pexel);
...
polyPainter_PolyPainter.prototype = {
	...
	,drawImageTriangle: function(ax,ay,bx,by,cx,cy,au,av,bu,bv,cu,cv,img) {
		var color = -1;
